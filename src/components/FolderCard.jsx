...
export default function FolderCard({ icon, title,link }) {
  return (
    <Link to={link}>
    <div className="bg-neutral-700 hover:bg-neutral-600 p-6 rounded-2xl text-center h-45 cursor-pointer transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
