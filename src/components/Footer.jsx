        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="flex flex-col items-center justify-between sm:flex-row gap-4">
            ...
            <button 
              ...
              className="cursor-pointer group flex items-center gap-2 px-4 py-2 text-sm text-neutral-500 hover:text-orange-400 transition-all duration-300 hover:bg-neutral-800/50 rounded-lg border border-transparent hover:border-neutral-700"
