...
const ContactUs = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await service.executeContactFormFunction(formData);
            setStatus('Message sent successfully!');
            setFormData({ name: '', email: '', message: '' }); 
        } catch (error) {
            console.error('Appwrite execution failed:', error);
                            ...
                            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                                ...
                                <div className="flex flex-col text-left">
                                    ...
                                    <div className="mt-8 flex flex-grow flex-col justify-center space-y-6">
                                        <a href="https://www.linkedin.com/in/pranjay-dwivedi-dev20/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 rounded-lg bg-white/10 p-4 transition hover:bg-white/20">
                                        ...
                                        <a href="https://www.linkedin.com/in/harikesh-pandey-4658172a3" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 rounded-lg bg-white/10 p-4 transition hover:bg-white/20">
                                            <svg className="h-8 w-8 flex-shrink-0 text-orange-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path></svg>
                                            <div>
                                        ...
                                        <a href="https://github.com/Panjoy1520/GBPUATNotes" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 rounded-lg bg-white/10 p-4 transition hover:bg-white/20">
