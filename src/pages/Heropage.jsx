      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6 z-20">
          ...
          <button 
            ...
            className={`cursor-pointer mt-8 bg-orange-500 hover:bg-orange-600 px-8 py-3 rounded-lg text-lg font-semibold text-white shadow-lg shadow-orange-500/20 transition-all duration-500 delay-200 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/30 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          >
