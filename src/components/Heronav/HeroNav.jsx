        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/login">
                <button className="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-lg font-semibold transition-transform duration-200 hover:scale-105">
                  Sign In
                </button>
              </Link>
            </div>
        ...
        <div className="relative z-50 flex flex-col items-center justify-center h-full">
          <div className="flex flex-col items-center space-y-8">
            ...
            <Link to="/login" onClick={handleLinkClick}>
              <button 
                className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold text-xl transition-all duration-300 transform hover:scale-110 mt-4"
                style={{
